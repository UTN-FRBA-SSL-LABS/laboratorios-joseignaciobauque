...
```bash
make grade LAB=lab-compilacion-c
```
...
`labs/lab-compilacion-c/`; la nota queda en el resumen y en los artefactos de
GitHub Actions.
...
> **R: Porque se trajo todas las bibliotecas, macros y funciones externas al programa.**
...
> **R: Eso se debe a que todos los comentarios fueron eliminados durante la etapa de preprocesamiento.**
...
> **R: Nos muestran el numero de linea donde estaban las funciones y en que archivo se encontraban definidas, en este caso printf esta definida en stdio.h**
...
> **R: .globl sumar .def sumar; .scl 2; .type 32; .endef .seh_proc sumar sumar: .ascii "sumar(3, 4) = %d\12\0" .ascii "Llamadas a sumar(): %d\12\0" call sumar**

Explicá en términos generales qué hacen esas instrucciones
(usá los comentarios del laboratorio como guía):

> **R: Por lo que tengo entenido, con el call esta llamando a la funcion sumar, con el ascii esta tomando la frase como una cadena de caracteres en formato ascii y con def esta definiendo las funciones.**
...
> **R: .globl llamadas llamadas: movl llamadas(%rip), %eax movl %eax, llamadas(%rip) movl llamadas(%rip), %eax**
...
> **R:0000000000000000 b .bss 0000000000000000 d .data 0000000000000000 p .pdata 0000000000000000 r .rdata 0000000000000000 r .rdata$zzz 0000000000000000 t .text 0000000000000000 r .xdata U __imp___acrt_iob_func U __main U __mingw_vfprintf U area_circulo U factorial 0000000000000195 T imprimir_separador 0000000000000000 B llamadas 0000000000000074 T main 0000000000000000 t printf 0000000000000051 T sumar**
...
> **R: Eso se debe a que area circulo, su funcion, esta definida en matematica.o pero no en programa.o**
...
> **R: Quedan, porque es parte de una biblioteca dinamica y se va a asignar una vez se ejecute el programa.**
